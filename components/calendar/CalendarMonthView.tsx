        ...
        {dates.map((date) => {
          ...
          return (
            ...
            >
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4px', flex: 1, alignContent: exclusionType === 'holiday' ? 'flex-start' : 'space-around', minHeight: 0, overflow: 'hidden', maxHeight: exclusionType === 'holiday' ? '14px' : undefined }}>
